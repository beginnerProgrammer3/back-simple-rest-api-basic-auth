...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(CarRepository carRepository, UserRepository userRepository, VerificationTokenRepository verificaationTokenRepository) {
...
//        verificaationTokenRepository.save(token1);
        ...
        ApkUser apkUser1 = new ApkUser("admin","www@wp",passwordEncoder().encode("1234"),"USER",false);
